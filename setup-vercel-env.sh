...
echo "AIzaSyBqzXjL5mufp6DCXaqUQefSeOv0ZdpBO00" | npx vercel env add VITE_FIREBASE_API_KEY production
...
echo "1:727407011562:web:81aec7bade49e229341993" | npx vercel env add VITE_FIREBASE_APP_ID production
...
echo "AIzaSyBqzXjL5mufp6DCXaqUQefSeOv0ZdpBO00" | npx vercel env add VITE_FIREBASE_API_KEY preview
...
echo "sk-8e2300fe9ce04d409ce0be4d97d3dc34" | npx vercel env add VITE_DEEPSEEK_API_KEY preview

echo "AIzaSyBqzXjL5mufp6DCXaqUQefSeOv0ZdpBO00" | npx vercel env add VITE_FIREBASE_API_KEY development
...
echo "1:727407011562:web:81aec7bade49e229341993" | npx vercel env add VITE_FIREBASE_APP_ID development
echo "sk-8e2300fe9ce04d409ce0be4d97d3dc34" | npx vercel env add VITE_DEEPSEEK_API_KEY development
